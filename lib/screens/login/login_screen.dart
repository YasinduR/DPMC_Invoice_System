...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppPage(
      canPop: false,
      title: _currentView == LoginScreenView.loginForm ? 'Login' : 'Set Password',
      showAppBar: false, // No app bar for login/password setup
      showFooter: true, // Show the common footer
      //contentPadding: EdgeInsets.zero, // Child views handle their own padding
