...
import 'package:myapp/services/api_service.dart' show ApiService;
...
class AuthService {
  ...
  //     // await NotificationService.clearCurrentAppUser(); Dont remove add later if required
  //   } catch (e) {
  //     return null;
  //   } finally {
...
Future<void> changePassword({
  ...
  return await execute<String>(
    context: context,
    task: () => api.requestPasswordReset(username: username),
    onError: onError,
  );
}
